...
public class JsonTest {
  ...
  public void shouldDeserializeArray() throws IOException {
    ...
    final String json = "[\n"
                        ...
                        + "        \"name\": \"redis\",\n"
                        + "        \"state\": \"running\",\n"
                        + "        \"createdAt\": 1502192853851821300,\n"
                        + "        \"startedAt\": 1502192853947821300,\n"
                        + "        \"imageId\": \"sha512-5ab3bca3027d512e181862990e153361ed37e67af9b4aeeb0637100ee473d234\"\n"
                        + "      }\n"
                        + "    ],\n"
                        + "    \"startedAt\": 1502192853\n"
                        + "  },\n"
                        + "  {\n"
