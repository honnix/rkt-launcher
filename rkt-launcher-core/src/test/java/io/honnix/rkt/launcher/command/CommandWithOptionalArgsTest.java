...
public class CommandWithOptionalArgsTest {

  @Test
  public void shouldBuildCorrectListWithoutArgsOptions() throws Exception {
    final CommandWithOptionalArgs commandWithOptionalArgs = new CommandWithOptionalArgs() {
      @Override
    ...
    assertEquals(expected, commandWithOptionalArgs.asList("foo"));
  }
  ...
  public void shouldBuildCorrectListWithArgsOptions() throws Exception {
    final CommandWithOptionalArgs commandWithOptionalArgs = new CommandWithOptionalArgs() {
      @Override
      public Optional<List<String>> args() {
        return Optional.of(ImmutableList.of("arg1", "arg2"));
      }
